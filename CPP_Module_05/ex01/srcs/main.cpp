...
/*   Updated: 2023/07/10 15:43:59 by maparigi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
		...
		Form *c = new Form("Rent Contract", 140, 100, 0);
		std::cout << std::endl;
